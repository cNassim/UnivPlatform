    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_pays', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='etudiant.pays')),
                ('id_superadmin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='etudiant.superadmin')),
            ],
        ),
        migrations.CreateModel(
            name='Formation',
            fields=[
                ...
                ('id_spécialité', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='etudiant.spécialité')),
                ('id_univ', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='etudiant.université')),
            ],
        ),
        migrations.CreateModel(
            name='Etudiant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='etudiant.agent')),
        ...
        migrations.CreateModel(
            name='Postuler',
            fields=[
                ('id_univ', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='etudiant.université')),
                ('id_agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='etudiant.agent')),
            ],
        ),
        migrations.CreateModel(
            name='Choisir',
            fields=[
                ('id_candidature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='etudiant.candidature')),
                ('id_etudiant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='etudiant.etudiant')),
            ],
        ),
    ]
