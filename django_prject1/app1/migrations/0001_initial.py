...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='superadmin',
            fields=[
                ('id_superadmin', models.IntegerField(primary_key=True, serialize=False)),
                ('Nom', models.CharField(max_length=50)),
                ('Prenom', models.CharField(max_length=50)),
                ('Email', models.EmailField(max_length=50)),
                ('password', models.CharField(max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_pays', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.pays')),
                ('id_superadmin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.superadmin')),
            ],
        ),
        migrations.CreateModel(
            name='Formation',
            fields=[
                ...
                ('id_spécialité', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.spécialité')),
                ('id_univ', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.université')),
            ],
        ),
        migrations.CreateModel(
            name='Etudiant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.agent')),
                ('id_etudiant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.etudiant')),
            ],
        ),
        migrations.CreateModel(
            name='Postuler',
            fields=[
                ('id_univ', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='app1.université')),
                ('id_agent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.agent')),
            ],
        ),
        migrations.CreateModel(
            name='Choisir',
            fields=[
                ('id_candidature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='app1.candidature')),
                ('id_etudiant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app1.etudiant')),
            ],
        ),
    ]
