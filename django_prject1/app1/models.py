...
class superadmin(models.Model):
    id_superadmin = models.IntegerField(primary_key=True)
    Nom = models.CharField(max_length=50)
    Prenom = models.CharField(max_length=50)
    Email = models.EmailField(max_length=50)
    password = models.CharField(max_length=50)
...
class Université(models.Model):
    ...
    id_superadmin = models.ForeignKey(superadmin, on_delete=models.CASCADE)
    id_pays = models.ForeignKey(Pays, on_delete=models.CASCADE)
...
class Choisir(models.Model):
    id_etudiant = models.ForeignKey(Etudiant, on_delete=models.CASCADE)
    id_candidature = models.ForeignKey(Candidature, on_delete=models.CASCADE, primary_key=True)

class Postuler(models.Model):
    id_agent = models.ForeignKey(Agent, on_delete=models.CASCADE)
    id_univ = models.ForeignKey(Université, on_delete=models.CASCADE, primary_key=True)
